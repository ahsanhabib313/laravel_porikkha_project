...
{!! Html::style('css/header.css') !!}{!! Html::style('css/master.css') !!}
...
<div class="container">
    ...
    <div class="row print ">
        <div class="col-md-12 jumbotron">
            <div class="">
                <a href="{{url('/dashboard/tabulationSheet/print')}}/{{$id}}" class="btn btn-info btn-lg btn-block printbtn" >Print <i class="fa fa-print" aria-hidden="true"></i></a>
            </div>
        </div>
    </div>
