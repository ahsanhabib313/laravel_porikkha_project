    ...
    <div class="row UserDeleteContent ">
        <div class="col-md-12">
            ...
            <div class="pull-right">
                <a href="{{url('print')}}/{{$semester}}" class="btn btn-info btn-lg printbtn">Next<i class="fa fa-print"
                                                                                                aria-hidden="true"></i></a>
                <a href="{{url('/dashboard')}}" class="btn btn-primary btn-lg" type="submit">Cancel</a>
            </div>
