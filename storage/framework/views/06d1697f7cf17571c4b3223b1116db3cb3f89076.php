                    ...
                    <ul class="dropdown-menu">
                        <?php if($user->role == 'Program Officer'): ?>
                           ...
                           <?php /* <li role="separator" class="divider"></li>
                            ...
                            <li role="separator" class="divider"></li>
                            <li><a href="<?php echo e(url('dashboard/student/View/search')); ?>">View</a></li>
                        <?php else: ?>
                            <li><a href="<?php echo e(url('dashboard/student/View/search')); ?>">View</a></li>
                        <?php endif; ?>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="xyz">
                        <?php if($user->role == 'Program Officer'): ?>
                            ...
                            <li role="separator" class="divider"></li>
                       <?php /* <li><a href="<?php echo e(url('/dashboard/course/delete')); ?>">Delete</a></li>
                            <li role="separator" class="divider"></li>*/ ?>
                            <li><a href="<?php echo e(url('/dashboard/course/view/search')); ?>">View</a></li>
                            <li role="separator" class="divider"></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="xyz">
                        <?php if($user->role == 'Teacher'): ?>
                            <li><a href="<?php echo e(url('dashboard/gradeSheet/create')); ?>">Generate</a></li>
                            <li role="separator" class="divider"></li>
                ...
                <li class="dropdown">
                    ...
                    <?php if($user->role=='Coordinator'): ?>
                        <ul class="dropdown-menu" aria-labelledby="xyz">
                            ...
                            <li role="separator" class="divider"></li>
                            <li><a href="<?php echo e(url('/dashboard/tabulation/view/search')); ?>">View</a></li>
                            <li role="separator" class="divider"></li>
