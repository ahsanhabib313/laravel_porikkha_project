    ...
    <div class="row UserDeleteContent ">
        <div class="col-md-12">
            ...
            <div class="pull-right">
                <a href="<?php echo e(url('print')); ?>/<?php echo e($semester); ?>" class="btn btn-info btn-lg printbtn">Next<i class="fa fa-print"
                                                                                                aria-hidden="true"></i></a>
                <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-primary btn-lg" type="submit">Cancel</a>
            </div>
