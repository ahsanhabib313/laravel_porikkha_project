    ...
    <div class="row UserDeleteContent">
        <div class="col-md-12">
            ...
            <div class="pull-right">
                <a href="<?php echo e(url('/dashboard/gradeSheet/print')); ?>/<?php echo e($courseNames->course_id); ?>/<?php echo e(date('Y')); ?>"
                   class="btn btn-info printbtn btn-lg">Next <i class="fa fa-print" aria-hidden="true"></i></a>
                <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-primary  btn-lg">Cancel</a>
            </div>
